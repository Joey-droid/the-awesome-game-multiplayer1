...
controller.player2.onButtonEvent(ControllerButton.A, ControllerButtonEvent.Pressed, function () {
    controller.player2.moveSprite(myBall)
})
info.player2.onLifeZero(function () {
    game.over(false)
})
controller.A.onEvent(ControllerButtonEvent.Repeated, function () {
    controller.player3.moveSprite(myBall)
})
...
controller.player1.onButtonEvent(ControllerButton.A, ControllerButtonEvent.Pressed, function () {
    controller.player1.moveSprite(myBall)
})
...
. . . . . . . . . . . . . . . . 
`, SpriteKind.Enemy)
myBall.setPosition(30, 86)
mySprite.setPosition(24, 46)
mySprite2.setPosition(83, 69)
myEnemy.setPosition(138, 93)
...
game.showLongText("first mission is to destroy your enemy he is the one that is red. kick the ball onto the enemy then, you pass this level", DialogLayout.Center)
